...
(function(window, doc) {
    ...
    iScroll.prototype = {
        ...
        _move : function(e) {
            ...
            console.log('move' + newX);
            if(newX < -2000){
                for(var i=0;i<6;i++){
                    var element = $('#thelist').children().eq(0);
                    //$('#thelist').children().eq(0).remove();
                    console.log(element);
        ...
        _momentum : function(dist, time, maxDistUpper, maxDistLower, size) {
            var deceleration = 0.006, speed = m.abs(dist) / time, newDist = (speed * speed) / (2 * deceleration), newTime = 0, outsideDist = 0;
